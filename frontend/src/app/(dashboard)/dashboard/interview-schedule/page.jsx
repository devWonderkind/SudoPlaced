    ...
    return (
        <>
            ...
            <div className="">
                ...
                <p className="text-sm text-muted-foreground">Manage your interview schedule and track progress.</p>
            </div>
            <div className="space-y-6 rounded-md h-full">
                <Tabs defaultValue="schedule">
                    <div className="flex justify-between sm:flex-row flex-col space-y-6 mt-6">
